    ...
    <div className="room-details-booking">
      {showMessage && (
        <p className="booking-success-message">
          Booking successful! Confirmation code: {confirmationCode}. You can
          also check booking in the profile.
          {/* An SMS and
        ...
        {showDatePicker && (
          <div className="date-picker-container">
            <DatePicker
              ...
              onChange={(date) => {
                setCheckInDate(date);
                // Optionally reset check-out date if it's before new check-in
